      ...
      <div className={`${styles.resume}`} id="resume">
        <div className={`${styles.header}`}>
          ...
          <span className={`${styles.right}`}>
            <div>
              <FontAwesomeIcon icon={faPhone} /> {props.phoneRef}
            </div>
            <a className={`${styles.mail}`} href={"mailto:" + props.emailRef}>
              <FontAwesomeIcon icon={faEnvelope} /> {props.emailRef}
            </a>
            {props.linksRef.length > 0 && (
              <>
                      ...
                      <div className={`${styles.subsection}`}>
                        <div className={`${styles.flexbox}`}>
                          <div className={`${styles.flex_left}`}>
                            <li className={`${styles.li}`}>
                              {project.name} (
                              {props.projectsRef[i].links.map((link, index) => (
                                <a
                                  key={index}
                                  className={`${styles.link}`}
                                  target="_blank"
